...
public class Sprite {
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite forest_map_grass = new Sprite(DEFAULT_SIZE, 2, 1,
        SpriteSheet.forestMapTiles,
        DEFAULT_SIZE, DEFAULT_SIZE);
    public static Sprite forest_map1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map2 = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map3 = new Sprite(DEFAULT_SIZE, 12, 0, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map4 = new Sprite(DEFAULT_SIZE, 12, 1, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map5 = new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map6 = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map7 = new Sprite(DEFAULT_SIZE, 11, 2, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map8 = new Sprite(DEFAULT_SIZE, 11, 1, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map9 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map10 = new Sprite(DEFAULT_SIZE, 2, 12, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map11 = new Sprite(DEFAULT_SIZE, 1, 12, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map12 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite forest_map13 = new Sprite(DEFAULT_SIZE, 11, 0, SpriteSheet.forestMapTiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    /*
    |--------------------------------------------------------------------------
    ...
    public static Sprite grass = new Sprite(DEFAULT_SIZE, 6, 0, SpriteSheet.tiles, DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite grass_flower = new Sprite(DEFAULT_SIZE, 6, 1, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    ...
    public static Sprite beehive = new Sprite(DEFAULT_SIZE, 6, 12, SpriteSheet.tiles, DEFAULT_SIZE,
        DEFAULT_SIZE);
    //DeeDee
    public static Sprite deedee_left = new Sprite(DEFAULT_SIZE, 12, 9, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_right = new Sprite(DEFAULT_SIZE, 13, 9, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_left_eat = new Sprite(DEFAULT_SIZE, 12, 10, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_right_eat = new Sprite(DEFAULT_SIZE, 13, 10, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_left_chew1 = new Sprite(DEFAULT_SIZE, 12, 11, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_left_chew2 = new Sprite(DEFAULT_SIZE, 14, 9, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_right_chew1 = new Sprite(DEFAULT_SIZE, 13, 11, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_right_chew2 = new Sprite(DEFAULT_SIZE, 15, 9, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_left_ble1 = new Sprite(DEFAULT_SIZE, 14, 10, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_left_ble2 = new Sprite(DEFAULT_SIZE, 14, 11, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_right_ble1 = new Sprite(DEFAULT_SIZE, 15, 10, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_right_ble2 = new Sprite(DEFAULT_SIZE, 15, 11, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite deedee_dead = new Sprite(DEFAULT_SIZE, 12, 12, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    //DEATH
    ...
    public static Sprite bomb_2 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.tiles, DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite bomb_enemy = new Sprite(DEFAULT_SIZE, 0, 4, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite bomb_enemy_1 = new Sprite(DEFAULT_SIZE, 1, 4, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite bomb_enemy_2 = new Sprite(DEFAULT_SIZE, 2, 4, SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    /*
    |--------------------------------------------------------------------------
    ...
    public static Sprite bomb_exploded_enemy2 = new Sprite(DEFAULT_SIZE, 4, 7, SpriteSheet.tiles,
        DEFAULT_SIZE, DEFAULT_SIZE);
    public static Sprite explosion_vertical_enemy = new Sprite(DEFAULT_SIZE, 5, 6,
        SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite explosion_vertical_enemy1 = new Sprite(DEFAULT_SIZE, 6, 6,
        SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite explosion_vertical_enemy2 = new Sprite(DEFAULT_SIZE, 7, 6,
        SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite explosion_horizontal_enemy = new Sprite(DEFAULT_SIZE, 5, 8,
        SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite explosion_horizontal_enemy1 = new Sprite(DEFAULT_SIZE, 5, 9,
        SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
    public static Sprite explosion_horizontal_enemy2 = new Sprite(DEFAULT_SIZE, 5, 10,
        SpriteSheet.tiles,
        DEFAULT_SIZE,
        DEFAULT_SIZE);
